...
test_strings1 = ["    +18329jchdbckjdhb", "    Ciao mondo", "Ciao mondo", "    Ciao mondo", ""]
test_strings2 = ["  +18329jchdbckjdhb", "    +18329jchdbckjdhb", "    +18329jchdbckjdhb", "+18329jchdbckjdhb", "+18329jchdbckjdhb"]
test_sizes = [len(test_strings1[0]), len(test_strings1[1]), len(test_strings1[2]), len(test_strings1[3]), len(test_strings1[4])]
